...
public class Morris {
     ...
     */
    public static void process(BinaryTree.Node curNode) {
        if (curNode == null) {
            // base case
            return;
        }
     ...
     * @param root 根节点
     */
    public static void morris(BinaryTree.Node root) {
        if (root == null) {
            // cur为空时, 退出遍历
            return;
        }
     ...
     * @param root 根节点
     */
    public static void morrisPreorderTraversal(BinaryTree.Node root) {
        if (root == null) {
            // cur为空时, 退出遍历
            return;
        }
     ...
     * @param root 根节点
     */
    public static void morrisInorderTraversal(BinaryTree.Node root) {
        if (root == null) {
            // cur为空时, 退出遍历
            return;
        }
     ...
     * morris后序遍历实现
     */
    public static void morrisPostorderTraversal(BinaryTree.Node root) {
        if (root == null) {
            // cur为空时, 退出遍历
            return;
        }
     ...
     * @param root 根节点
     */
    private static void printReverse(BinaryTree.Node root) {
        // 逆序右边界, tail指向右边界的尾结点, 即逆序后的头结点, cur 指向 tail
        BinaryTree.Node tail = reverse(root), cur = tail;
        while (cur != null) {
            System.out.println(cur);
            cur = cur.right;
        }
     ...
     * @param cur 当前节点
     */
    private static BinaryTree.Node reverse(BinaryTree.Node cur) {
        // pre记录cur的前一个结点, next指向cur的后一个节点
        BinaryTree.Node pre = null, next;
        while (cur != null) {
            next = cur.right;
            cur.right = pre;
            pre = cur;
